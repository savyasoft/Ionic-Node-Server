...
(function(U, ca, p) {
            ...
            function(a, b, c, h, k, j) {
                function l(a) {
                    ...
                    var e = a.transformRequest ||
                        ...
                        }, h.common, h[E(a.method)], a.headers),
                        e = Ob(a.data, Nb(h), e),
                        g;
    ...
    var Ed = S(function(a, c, d) {
        ...
        Fd = ["$http", "$templateCache", "$anchorScroll", "$compile",
            function(a, c, d, e) {
                return {
                    restrict: "ECA",
                    terminal: !0,
        ...
        Rd = ["$http", "$templateCache", "$route", "$anchorScroll", "$compile", "$controller",
                            ...
                            function h() {
                                ...
                                for (y = c.length; w < y; w++) {
                                    ...
                                    if (v.length <= w) s = {
                                        ...
                                        label: i.label
                                    }, t = [s], v.push(t), f.append(s.element);
